...
export type { Policy as SubductionPolicy, Transport as SubductionTransport, } from "@automerge/automerge-subduction/slim";
 ...
 * ```
 */
export declare function setupSubduction({ signer, storageAdapter, }: SetupSubductionOptions): Promise<SetupSubductionResult>;
