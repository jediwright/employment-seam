...
export function cborByteString(bytes) {
...
function cborArrayHeader(length) {
    if (length < 24)
...
export function cborUint(value) {
    if (value < 24)
...
export function buildSyncResponseCbor(requested, cborFoundEvents, syncResponderTotal, syncRequesterTotal) {
    const parts = [];
...
export function buildSyncOpsCbor(cborItems, syncResponderTotal, syncRequesterTotal) {
    const parts = [];
...
export function buildCborByteStringArray(cborItems) {
