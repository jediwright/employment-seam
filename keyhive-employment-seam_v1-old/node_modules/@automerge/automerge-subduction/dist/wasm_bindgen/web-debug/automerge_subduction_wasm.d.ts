...
export interface InitOutput {
    ...
    readonly init: () => void;
    readonly start_automerge_subduction_wasm: () => void;
    readonly commitIdOfBase58Id: (a: number, b: number) => [number, number, number];
    ...
    readonly subduction_new: (a: any) => [number, number, number];
    readonly subduction_storeSedimentree: (a: number, b: number, c: number, d: number, e: number) => any;
    readonly subduction_addSedimentree: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
    ...
    readonly subduction_fetchBlobs: (a: number, b: number, c: number) => any;
    readonly subduction_storeCommit: (a: number, b: number, c: number, d: number, e: number, f: any) => any;
    readonly subduction_addCommit: (a: number, b: number, c: number, d: number, e: number, f: any) => any;
    readonly subduction_storeFragment: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: any) => any;
    readonly subduction_addFragment: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: any) => any;
    readonly subduction_storeBuiltBatch: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
    readonly subduction_addBatch: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => any;
    readonly subduction_storeCommitsBatch: (a: number, b: number, c: number, d: number) => any;
    readonly subduction_addCommitsBatch: (a: number, b: number, c: number, d: number, e: number) => any;
    readonly subduction_storeFragmentsBatch: (a: number, b: number, c: number, d: number) => any;
    readonly subduction_addFragmentsBatch: (a: number, b: number, c: number, d: number, e: number) => any;
    readonly subduction_commitDepth: (a: number, b: number) => number;
    readonly subduction_syncWithPeer: (a: number, b: number, c: number, d: number, e: number) => any;
    readonly subduction_syncWithAllPeers: (a: number, b: number, c: number, d: number) => any;
    readonly subduction_fullSyncWithPeer: (a: number, b: number, c: number, d: number) => any;
    readonly subduction_fullSyncWithAllPeers: (a: number, b: number) => any;
    ...
    readonly subduction_registerFrameHandler: (a: number, b: number) => any;
    readonly subduction_sendKeyhiveMessage: (a: number, b: number, c: number, d: number) => any;
    ...
    readonly subduction_getAllHeads: (a: number) => any;
    readonly subduction_getConnectedPeerIds: (a: number) => any;
    readonly subduction_storage: (a: number) => any;
    readonly __wbg_sedimentreeheads_free: (a: number, b: number) => void;
    readonly sedimentreeheads_id: (a: number) => number;
    readonly sedimentreeheads_heads: (a: number) => [number, number];
    ...
    readonly start_subduction_wasm: () => void;
    readonly __wbg_commitinput_free: (a: number, b: number) => void;
    readonly commitinput_new: (a: number, b: number, c: number) => number;
    readonly commitinput_commit: (a: number) => number;
    readonly commitinput_blob: (a: number) => any;
    readonly __wbg_fragmentinput_free: (a: number, b: number) => void;
    readonly fragmentinput_new: (a: number, b: number, c: number) => number;
    readonly fragmentinput_fragment: (a: number) => number;
    readonly fragmentinput_blob: (a: number) => any;
    ...
    readonly topic___wasm_refgen_toWasmTopic: (a: number) => number;
    readonly start_sedimentree_wasm: () => void;
    readonly setSubductionLogLevel: (a: number, b: number) => [number, number];
    readonly set_subduction_logger: (a: any) => void;
    readonly clear_subduction_logger: () => void;
    ...
    readonly depth_isBoundary: (a: number) => number;
    ...
    readonly memorystorage_containsSedimentreeId: (a: number, b: number) => any;
    ...
    readonly __wbg_indexeddbstorage_free: (a: number, b: number) => void;
    readonly indexeddbstorage_setup: (a: any, b: number, c: number) => any;
    readonly indexeddbstorage_sedimentreeIdStoreName: (a: number) => [number, number];
    readonly indexeddbstorage_looseCommitStoreName: (a: number) => [number, number];
    readonly indexeddbstorage_fragmentStoreName: (a: number) => [number, number];
    readonly indexeddbstorage_saveSedimentreeId: (a: number, b: number) => any;
    readonly indexeddbstorage_deleteSedimentreeId: (a: number, b: number) => any;
    readonly indexeddbstorage_loadAllSedimentreeIds: (a: number) => any;
    readonly indexeddbstorage_saveCommit: (a: number, b: number, c: number, d: number, e: any) => any;
    readonly indexeddbstorage_loadCommit: (a: number, b: number, c: number) => any;
    readonly indexeddbstorage_listCommitIds: (a: number, b: number) => any;
    readonly indexeddbstorage_loadAllCommits: (a: number, b: number) => any;
    readonly indexeddbstorage_deleteCommit: (a: number, b: number, c: number) => any;
    readonly indexeddbstorage_deleteAllCommits: (a: number, b: number) => any;
    readonly indexeddbstorage_saveFragment: (a: number, b: number, c: number, d: number, e: any) => any;
    readonly indexeddbstorage_loadFragment: (a: number, b: number, c: number) => any;
    readonly indexeddbstorage_listFragmentIds: (a: number, b: number) => any;
    readonly indexeddbstorage_loadAllFragments: (a: number, b: number) => any;
    readonly indexeddbstorage_deleteFragment: (a: number, b: number, c: number) => any;
    readonly indexeddbstorage_deleteAllFragments: (a: number, b: number) => any;
    readonly indexeddbstorage_saveBatchAll: (a: number, b: number, c: any, d: any) => any;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h8de29c5c187b08b5: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__heba7f4bd59200b35: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hf74e869655887d7b: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h32c495d4ba96a9e5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5e8ee6f6db787c4f: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h6d0920364a328127: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h927e8a4895657235: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hc5f86960f9efa147: (a: number, b: number) => number;
    readonly wasm_bindgen__convert__closures_____invoke__h2bfe2f7cd2dcf4fd: (a: number, b: number) => void;
