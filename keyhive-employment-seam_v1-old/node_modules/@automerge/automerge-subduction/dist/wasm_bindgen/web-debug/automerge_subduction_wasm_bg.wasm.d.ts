...
export const start_automerge_subduction_wasm: () => void;
export const commitIdOfBase58Id: (a: number, b: number) => [number, number, number];
...
export const subduction_new: (a: any) => [number, number, number];
export const subduction_storeSedimentree: (a: number, b: number, c: number, d: number, e: number) => any;
export const subduction_addSedimentree: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
...
export const subduction_fetchBlobs: (a: number, b: number, c: number) => any;
export const subduction_storeCommit: (a: number, b: number, c: number, d: number, e: number, f: any) => any;
export const subduction_addCommit: (a: number, b: number, c: number, d: number, e: number, f: any) => any;
export const subduction_storeFragment: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: any) => any;
export const subduction_addFragment: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: any) => any;
export const subduction_storeBuiltBatch: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
export const subduction_addBatch: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => any;
export const subduction_storeCommitsBatch: (a: number, b: number, c: number, d: number) => any;
export const subduction_addCommitsBatch: (a: number, b: number, c: number, d: number, e: number) => any;
export const subduction_storeFragmentsBatch: (a: number, b: number, c: number, d: number) => any;
export const subduction_addFragmentsBatch: (a: number, b: number, c: number, d: number, e: number) => any;
export const subduction_commitDepth: (a: number, b: number) => number;
export const subduction_syncWithPeer: (a: number, b: number, c: number, d: number, e: number) => any;
export const subduction_syncWithAllPeers: (a: number, b: number, c: number, d: number) => any;
export const subduction_fullSyncWithPeer: (a: number, b: number, c: number, d: number) => any;
export const subduction_fullSyncWithAllPeers: (a: number, b: number) => any;
...
export const subduction_registerFrameHandler: (a: number, b: number) => any;
export const subduction_sendKeyhiveMessage: (a: number, b: number, c: number, d: number) => any;
...
export const subduction_getAllHeads: (a: number) => any;
export const subduction_getConnectedPeerIds: (a: number) => any;
export const subduction_storage: (a: number) => any;
export const __wbg_sedimentreeheads_free: (a: number, b: number) => void;
export const sedimentreeheads_id: (a: number) => number;
export const sedimentreeheads_heads: (a: number) => [number, number];
...
export const start_subduction_wasm: () => void;
export const __wbg_commitinput_free: (a: number, b: number) => void;
export const commitinput_new: (a: number, b: number, c: number) => number;
export const commitinput_commit: (a: number) => number;
export const commitinput_blob: (a: number) => any;
export const __wbg_fragmentinput_free: (a: number, b: number) => void;
export const fragmentinput_new: (a: number, b: number, c: number) => number;
export const fragmentinput_fragment: (a: number) => number;
export const fragmentinput_blob: (a: number) => any;
...
export const topic___wasm_refgen_toWasmTopic: (a: number) => number;
export const start_sedimentree_wasm: () => void;
export const setSubductionLogLevel: (a: number, b: number) => [number, number];
export const set_subduction_logger: (a: any) => void;
export const clear_subduction_logger: () => void;
...
export const depth_isBoundary: (a: number) => number;
...
export const memorystorage_containsSedimentreeId: (a: number, b: number) => any;
...
export const __wbg_indexeddbstorage_free: (a: number, b: number) => void;
export const indexeddbstorage_setup: (a: any, b: number, c: number) => any;
export const indexeddbstorage_sedimentreeIdStoreName: (a: number) => [number, number];
export const indexeddbstorage_looseCommitStoreName: (a: number) => [number, number];
export const indexeddbstorage_fragmentStoreName: (a: number) => [number, number];
export const indexeddbstorage_saveSedimentreeId: (a: number, b: number) => any;
export const indexeddbstorage_deleteSedimentreeId: (a: number, b: number) => any;
export const indexeddbstorage_loadAllSedimentreeIds: (a: number) => any;
export const indexeddbstorage_saveCommit: (a: number, b: number, c: number, d: number, e: any) => any;
export const indexeddbstorage_loadCommit: (a: number, b: number, c: number) => any;
export const indexeddbstorage_listCommitIds: (a: number, b: number) => any;
export const indexeddbstorage_loadAllCommits: (a: number, b: number) => any;
export const indexeddbstorage_deleteCommit: (a: number, b: number, c: number) => any;
export const indexeddbstorage_deleteAllCommits: (a: number, b: number) => any;
export const indexeddbstorage_saveFragment: (a: number, b: number, c: number, d: number, e: any) => any;
export const indexeddbstorage_loadFragment: (a: number, b: number, c: number) => any;
export const indexeddbstorage_listFragmentIds: (a: number, b: number) => any;
export const indexeddbstorage_loadAllFragments: (a: number, b: number) => any;
export const indexeddbstorage_deleteFragment: (a: number, b: number, c: number) => any;
export const indexeddbstorage_deleteAllFragments: (a: number, b: number) => any;
export const indexeddbstorage_saveBatchAll: (a: number, b: number, c: any, d: any) => any;
...
export const wasm_bindgen__convert__closures_____invoke__h8de29c5c187b08b5: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__heba7f4bd59200b35: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hf74e869655887d7b: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h32c495d4ba96a9e5: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h5e8ee6f6db787c4f: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h6d0920364a328127: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h927e8a4895657235: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hc5f86960f9efa147: (a: number, b: number) => number;
export const wasm_bindgen__convert__closures_____invoke__h2bfe2f7cd2dcf4fd: (a: number, b: number) => void;
