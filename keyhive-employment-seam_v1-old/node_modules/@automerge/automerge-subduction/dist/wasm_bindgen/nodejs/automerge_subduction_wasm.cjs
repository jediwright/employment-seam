...
const { tryIntoJsSedimentreeIdsArray } = require(String.raw`./snippets/sedimentree_wasm-564b9c00c3e4790f/inline2.js`);
...
const import1 = require("./snippets/subduction_wasm-a772716405a8e1bf/inline0.js");
const import2 = require("./snippets/subduction_wasm-a772716405a8e1bf/inline1.js");
