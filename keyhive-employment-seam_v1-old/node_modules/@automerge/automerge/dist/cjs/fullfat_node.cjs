...
var require_automerge_wasm = __commonJS({
  "mjs/wasm_bindgen_output/nodejs/automerge_wasm.cjs"(exports2) {
    ...
    var Automerge2 = class _Automerge {
       ...
       */
      addCommits(commits) {
        const ret = wasm2.automerge_addCommits(this.__wbg_ptr, commits);
        if (ret[1]) {
      ...
      addFragments(fragments) {
        const ret = wasm2.automerge_addFragments(this.__wbg_ptr, fragments);
        if (ret[1]) {
          throw takeFromExternrefTable02(ret[0]);
        }
      }
      ...
      bundleFragmentMetadata(fragments) {
        const ret = wasm2.automerge_bundleFragmentMetadata(this.__wbg_ptr, fragments);
        if (ret[2]) {
          throw takeFromExternrefTable02(ret[1]);
        }
        return takeFromExternrefTable02(ret[0]);
      ...
      getFragmentMeta(head) {
        const ret = wasm2.automerge_getFragmentMeta(this.__wbg_ptr, head);
        if (ret[2]) {
          throw takeFromExternrefTable02(ret[1]);
        }
        return takeFromExternrefTable02(ret[0]);
      ...
      getFragmentMetadata(levels) {
        const ret = wasm2.automerge_getFragmentMetadata(this.__wbg_ptr, levels);
        if (ret[2]) {
          throw takeFromExternrefTable02(ret[1]);
        }
        return takeFromExternrefTable02(ret[0]);
    ...
    function __wbg_get_imports2() {
      const import0 = {
        __proto__: null,
        __wbg_BigInt_783e2a7f4ba76bc4: function(arg0) {
        ...
        __wbg___wbindgen_gt_09497b4a65452cf9: function(arg0, arg1) {
          const ret = arg0 > arg1;
          return ret;
        },
        ...
        __wbg___wbindgen_lt_bf66da04b96dff63: function(arg0, arg1) {
          const ret = arg0 < arg1;
          return ret;
        },
        __wbg___wbindgen_neg_5c60abf0a760fcb3: function(arg0) {
          const ret = -arg0;
          return ret;
        },
        ...
        __wbg_apply_345835e57390767e: function() {
          return handleError2(function(arg0, arg1, arg2) {
            const ret = Reflect.apply(arg0, arg1, arg2);
            return ret;
          }, arguments);
        },
        __wbg_assign_6dc244143fa72f1f: function(arg0, arg1) {
        ...
        __wbg_concat_984be48c26a4a7d7: function(arg0, arg1) {
        ...
        __wbg_deleteProperty_598e2c418b0266c8: function() {
          return handleError2(function(arg0, arg1) {
        ...
        __wbg_for_6670787dec82acd0: function(arg0, arg1) {
          const ret = Symbol.for(getStringFromWasm02(arg0, arg1));
          return ret;
        },
        __wbg_freeze_bb8e564173b3cad6: function(arg0) {
        ...
        __wbg_instanceof_Date_699138a4c8668446: function(arg0) {
          let result;
          try {
        ...
        __wbg_ownKeys_cb08d3d8561f661f: function() {
          return handleError2(function(arg0) {
        ...
        __wbg_slice_ec02e3c14d84ad90: function(arg0, arg1, arg2) {
        ...
        __wbg_toString_30d9e686a1bd8b7e: function(arg0) {
          const ret = arg0.toString();
          return ret;
        },
        __wbg_toString_49bf30263e075265: function() {
          return handleError2(function(arg0, arg1) {
            const ret = arg0.toString(arg1);
            return ret;
          }, arguments);
        },
        __wbg_toString_7b43db62ff51d976: function(arg0, arg1, arg2) {
        ...
        __wbg_unshift_ed6145d5628f7a55: function(arg0, arg1) {
        ...
        __wbg_values_04e37d4db6696114: function(arg0) {
...
var Automerge = class _Automerge {
   ...
   */
  addCommits(commits) {
    const ret = wasm.automerge_addCommits(this.__wbg_ptr, commits);
    if (ret[1]) {
   ...
   */
  addFragments(fragments) {
    const ret = wasm.automerge_addFragments(this.__wbg_ptr, fragments);
    if (ret[1]) {
      throw takeFromExternrefTable0(ret[0]);
    }
  }
   ...
   */
  bundleFragmentMetadata(fragments) {
    const ret = wasm.automerge_bundleFragmentMetadata(this.__wbg_ptr, fragments);
    if (ret[2]) {
      throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
   ...
   */
  getFragmentMeta(head) {
    const ret = wasm.automerge_getFragmentMeta(this.__wbg_ptr, head);
    if (ret[2]) {
      throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
   ...
   */
  getFragmentMetadata(levels) {
    const ret = wasm.automerge_getFragmentMetadata(this.__wbg_ptr, levels);
    if (ret[2]) {
      throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
var JS_GIT_HEAD = "a656855f72b9753881f6c9a422ed3b5d8b841cb1";
