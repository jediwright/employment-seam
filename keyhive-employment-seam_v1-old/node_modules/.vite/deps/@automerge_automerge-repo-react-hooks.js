import { t as require_react } from "./react-CdyXI2GL.js";
import { C as PeerStateView, S as Presence } from "./dist-B1-lgGyo.js";
import "./slim-D-u7rO8u.js";
//#region node_modules/@automerge/automerge-repo-react-hooks/dist/index.js
...
function useDocument(id, params = { suspense: false }) {
	...
	const [doc, setDoc] = (0, import_react.useState)(() => handle?.doc());
	...
	const changeDoc = (0, import_react.useCallback)((changeFn, options) => {
...
function useSet(items) {
	const [set, setSet] = (0, import_react.useState)(() => {
...
function useDocHandles(ids, { suspense = false } = {}) {
	...
	const repo = useRepo();
	const [handleMap, setHandleMap] = (0, import_react.useState)(() => {
...
function useDocuments(ids, { suspense = true } = {}) {
	...
	const [docMap, setDocMap] = (0, import_react.useState)(() => {
	...
	return [docMap, (0, import_react.useCallback)((id, changeFn, options) => {
...
function useStateRef(initialState) {
	...
	return [
		state,
		(0, import_react.useCallback)((setStateAction) => {
...
function usePresence({ handle, initialState, heartbeatMs, peerTtlMs }) {
	const [localState, setLocalState] = (0, import_react.useState)(initialState);
	const [peerStates, setPeerStates] = (0, import_react.useState)(new PeerStateView({}));
	const firstOpts = (0, import_react.useRef)({
		heartbeatMs,
		peerTtlMs
	});
	const firstInitialState = (0, import_react.useRef)(initialState);
	const [presence] = (0, import_react.useState)(() => new Presence({ handle }));
	(0, import_react.useEffect)(() => {
		presence.start({
	...
	const start = (0, import_react.useCallback)((config) => {
	...
	return {
		peerStates,
		localState,
		update: (0, import_react.useCallback)((channel, msg) => {
...
//# sourceMappingURL=@automerge_automerge-repo-react-hooks.js.map