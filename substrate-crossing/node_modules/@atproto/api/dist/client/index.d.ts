...
export declare class AppBskyActorNS {
    _client: XrpcClient;
    contentVisibilityDeclaration: AppBskyActorContentVisibilityDeclarationRecord;
...
export declare class AppBskyActorContentVisibilityDeclarationRecord {
    _client: XrpcClient;
    constructor(client: XrpcClient);
    list(params: OmitKey<ComAtprotoRepoListRecords.QueryParams, 'collection'>): Promise<{
        ...
        records: {
            uri: string;
            value: AppBskyActorContentVisibilityDeclaration.Record;
        }[];
    }>;
    ...
    create(params: OmitKey<ComAtprotoRepoCreateRecord.InputSchema, 'collection' | 'record'>, record: Un$Typed<AppBskyActorContentVisibilityDeclaration.Record>, headers?: Record<string, string>): Promise<{
        uri: string;
        cid: string;
    }>;
    put(params: OmitKey<ComAtprotoRepoPutRecord.InputSchema, 'collection' | 'record'>, record: Un$Typed<AppBskyActorContentVisibilityDeclaration.Record>, headers?: Record<string, string>): Promise<{
        uri: string;
        cid: string;
    }>;
...
export declare class AppBskyVideoNS {
    _client: XrpcClient;
    constructor(client: XrpcClient);
    abortUpload(data?: AppBskyVideoAbortUpload.InputSchema, opts?: AppBskyVideoAbortUpload.CallOptions): Promise<AppBskyVideoAbortUpload.Response>;
    finishUpload(data?: AppBskyVideoFinishUpload.InputSchema, opts?: AppBskyVideoFinishUpload.CallOptions): Promise<AppBskyVideoFinishUpload.Response>;
    ...
    getUploadStatus(params?: AppBskyVideoGetUploadStatus.QueryParams, opts?: AppBskyVideoGetUploadStatus.CallOptions): Promise<AppBskyVideoGetUploadStatus.Response>;
    startUpload(data?: AppBskyVideoStartUpload.InputSchema, opts?: AppBskyVideoStartUpload.CallOptions): Promise<AppBskyVideoStartUpload.Response>;
    uploadPart(data?: AppBskyVideoUploadPart.InputSchema, opts?: AppBskyVideoUploadPart.CallOptions): Promise<AppBskyVideoUploadPart.Response>;
