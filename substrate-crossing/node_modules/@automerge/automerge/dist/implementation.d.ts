...
import type { Automerge, API as WasmAPI, Actor as ActorId, Prop, ObjID, Change, ChangeMetadata, FragmentMeta, Commit, Fragment, FragmentLevelRange, DecodedChange, DiffOptions, Heads, MaterializeValue, JsSyncState, SyncMessage, Span, DecodedSyncMessage, UpdateSpansConfig } from "./wasm_types.js";
export type { ChangeMetadata, FragmentMeta, Commit, Fragment, FragmentLevelRange, PutPatch, DelPatch, DiffOptions, SpliceTextPatch, InsertPatch, IncPatch, Span, SyncMessage, UpdateSpansConfig, } from "./wasm_types.js";
/** @hidden **/
type API = WasmAPI;
 ...
 */
export declare function anonymize<T>(doc: Doc<T>): Doc<Record<string, unknown>>;
 ...
 * @hidden
 */
export declare function getFragmentMetadata(doc: Doc<unknown>, levels?: FragmentLevelRange): FragmentMeta[];
/**
 ...
 * @hidden
 */
export declare function getFragmentMeta(doc: Doc<unknown>, head: string): FragmentMeta | null;
/**
 ...
 * @hidden
 */
export declare function bundleFragmentMetadata(doc: Doc<unknown>, fragments: FragmentMeta[]): Uint8Array[];
/**
 ...
 * @hidden
 */
export declare function getCommits(doc: Doc<unknown>): Commit[];
/**
 ...
 * @hidden
 */
export declare function getFragments(doc: Doc<unknown>, levels?: FragmentLevelRange): Fragment[];
/**
 ...
 * @hidden
 */
export declare function addCommits<T>(doc: Doc<T>, commits: Commit[], opts?: ApplyOptions<T>): Doc<T>;
/**
 ...
 * @hidden
 */
export declare function addFragments<T>(doc: Doc<T>, fragments: Fragment[], opts?: ApplyOptions<T>): Doc<T>;
/**
